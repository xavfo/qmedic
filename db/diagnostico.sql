...
CREATE DATABASE `hc` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci */;
USE `hc`;
...
CREATE TABLE `diagnostico` (
  ...
  `diagnosticoCategoria` varchar(200) collate latin1_general_ci default NULL,
